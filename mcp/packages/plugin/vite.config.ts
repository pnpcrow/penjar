...
const PLUGIN_PORT = parseInt(process.env.PENJAR_MCP_PLUGIN_PORT || "4400", 10);

console.log("Will define IS_MULTI_USER_MODE as:", JSON.stringify(MULTI_USER_MODE));
console.log("Will define PENJAR_MCP_WEBSOCKET_URL as:", JSON.stringify(WS_URI));
...
export default defineConfig({
    ...
    define: {
        ...
        PENJAR_MCP_WEBSOCKET_URL: JSON.stringify(WS_URI),
    },
});
