...
run_case \
  "strict-installer-nearmatch-expression-one-exponent-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1**1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1**1" \
...
run_case \
  "strict-installer-nearmatch-expression-one-gte-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1>=1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1>=1" \
...
run_case \
  "strict-installer-nearmatch-expression-one-triple-eq-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1===1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1===1" \
...
run_case \
  "strict-installer-nearmatch-expression-one-bang-double-eq-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1!==1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1!==1" \
...
run_case \
  "strict-installer-nearmatch-expression-one-nullish-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1??1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1??1" \
...
run_case \
  "strict-installer-nearmatch-expression-one-optional-dot-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1?.1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1?.1" \
...
run_case \
  "strict-installer-nearmatch-expression-one-plus-equals-zero-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1+=0' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1+=0" \
...
run_case \
  "strict-installer-nearmatch-expression-one-minus-equals-zero-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1-=0' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1-=0" \
...
run_case \
  "strict-installer-nearmatch-expression-one-times-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1*=1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1*=1" \
...
run_case \
  "strict-installer-nearmatch-expression-one-exponent-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1**=1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1**=1" \
...
run_case \
  "strict-installer-nearmatch-expression-one-div-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1/=1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1/=1" \
...
run_case \
  "strict-installer-nearmatch-expression-one-mod-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1%=1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1%=1" \
...
run_case \
  "strict-installer-nearmatch-expression-one-xor-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1^=1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1^=1" \
...
run_case \
  "strict-installer-nearmatch-expression-one-and-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1&=1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1&=1" \
...
run_case \
  "strict-installer-nearmatch-expression-one-pipe-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1|=1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1|=1" \
...
run_case \
  "strict-installer-nearmatch-expression-one-shift-left-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1<<=1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1<<=1" \
...
run_case \
  "strict-installer-nearmatch-expression-one-shift-right-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1>>=1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1>>=1" \
...
run_case \
  "strict-installer-nearmatch-expression-one-andand-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1&&=1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1&&=1" \
...
run_case \
  "strict-installer-nearmatch-expression-one-pipepipe-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1||=1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1||=1" \
...
run_case \
  "strict-installer-nearmatch-expression-one-nullish-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict installer mode parser should keep expression near-match alias '1??=1' non-strict when installer command is missing." \
  setup_release_runner_case \
  "1??=1" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-exponent-one-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1**1' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-gte-one-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1>=1' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-triple-eq-one-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1===1' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-bang-double-eq-one-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1!==1' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-nullish-one-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1??1' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-optional-dot-one-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1?.1' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-plus-equals-zero-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1+=0' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-minus-equals-zero-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1-=0' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-times-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1*=1' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-exponent-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1**=1' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-div-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1/=1' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-mod-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1%=1' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-xor-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1^=1' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-and-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1&=1' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-pipe-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1|=1' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-shift-left-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1<<=1' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-shift-right-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1>>=1' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-pipepipe-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1||=1' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
...
run_case \
  "strict-protocol-nearmatch-expression-one-nullish-equals-one-alias-missing-command-pass" \
  "pass" \
  "Strict protocol mode parser should keep expression near-match alias '1??=1' non-strict when protocol command is missing." \
  setup_release_runner_case \
  "0" \
