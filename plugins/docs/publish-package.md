...
- Ensure to update the [penjar](https://github.com/penjar/penjar/blob/develop/frontend/package.json) and [penjar-plugin-starter-template](https://github.com/penjar/penjar-plugin-starter-template) with every release to provide developers with the latest configuration and features.
