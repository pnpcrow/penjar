...
desc: See the Penjar plugin API changelog for version 1.0! Find breaking changes, deprecations, new features, and updated documentation. Try Penjar for free.
---
...
[https://doc.plugins.penjar.app/](https://doc.plugins.penjar.app/)
- New samples repository with lots of samples to use the API:
[https://github.com/penjar/penjar-plugins-samples](https://github.com/penjar/penjar-plugins-samples)
...
- Changed types names to remove the Penjar prefix. So for example: <code class="language-js">PenjarShape</code> becomes <code class="language-js">Shape</code>; <code class="language-js">PenjarFile</code> becomes <code class="language-js">File</code>, and so on. Check the [API documentation](https://doc.plugins.penjar.app/) for more details.
- Changes on the <code class="language-js">penjar.on</code> and <code class="language-js">penjar.off</code> methods.
Previously you had to send the original callback to the off method in order to remove an event listener. Now, <code class="language-js">penjar.on</code> will return an *id* that you can pass to the <code class="language-js">penjar.off</code> method in order to remove the listener.

Previously:
```js
penjar.on(‘pagechange’, myListener); // Register an event listener
penjar.off(‘pagechange’, myListener); // Remove previously registered listener
```

Now:
```js
const id = penjar.on(‘pagechange’, myListener);
penjar.off(id);
```
...
- Change some names to better align with the names in Penjar's UI.
  - type <code class="language-js">frame</code> is now <code class="language-js">board</code>:
    - <code class="language-js">PenjarFrame</code> is now <code class="language-js">Board</code>
    - <code class="language-js">penjar.createFrame</code> changed to <code class="language-js">penjar.createBoard</code>
    ...
    - <code class="language-js">PenjarFrameGuideX</code> now <code class="language-js">GuideX</code>
  - type<code class="language-js">rect</code> is <code class="language-js">rectangle</code>
    - <code class="language-js">PenjarRectangle</code> is now <code class="language-js">Rectangle</code>
  - type<code class="language-js">circle</code> is<code class="language-js">ellipse</code>
    - <code class="language-js">PenjarCircle</code> is now <code class="language-js">Ellipse</code>
    - <code class="language-js">penjar.createCircle</code> changed to <code class="language-js">penjar.createEllipse</code>
  - type<code class="language-js">bool</code> is<code class="language-js">boolean</code>
    - <code class="language-js">PenjarBool</code> is now <code class="language-js">Boolean</code>
...
- Adds method penjar.viewport.zoomToShapes to change the viewport to the shapes.
