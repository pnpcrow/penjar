...
- Release evidence index contract checker: `desktop/scripts/check_release_evidence_index_contract.sh` (includes missing-base-check-report attachment, missing-index-file, and invalid-decision regression cases).
