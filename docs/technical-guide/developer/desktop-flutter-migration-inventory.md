...
| Canvas interaction | `frontend/src/app/main/ui/workspace.cljs`, `frontend/src/app/main/ui/workspace/viewport.cljs`, `frontend/src/app/main/data/workspace/drawing.cljs` | Workspace viewport and drawing interactions run in web canvas runtime | Flutter canvas interaction layer with equivalent editing semantics | Baseline Flutter canvas editing surface is implemented; real rendering engine/contract integration remains pending | Workspace Core | 2026-07-15 | In progress | [Web + Desktop Phase C Execution Log](/technical-guide/developer/web-mcp-phase-c-execution-log/) |
