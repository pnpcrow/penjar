...
| Collaboration context | `frontend/src/app/main/ui/workspace/comments.cljs`, `frontend/src/app/main/ui/workspace/presence.cljs`, `frontend/src/app/main/data/workspace/comments.cljs` | Comments/presence awareness and thread flows are web workspace interactions | Flutter collaboration UI (presence/threads) with parity diagnostics hooks | Baseline Flutter collaboration surface is implemented; real presence/comment service integration remains pending | Collaboration + Realtime | 2026-08-15 | In progress | [Web + Desktop Phase C Execution Log](/technical-guide/developer/web-mcp-phase-c-execution-log/) |
