...
- Contract bundle coverage now includes strict-schema fallback-policy diagnostics label (`auth-backend-fallback: strict-schema`) in `desktop/test/contracts/desktop_contract_bundle_test.dart`.
