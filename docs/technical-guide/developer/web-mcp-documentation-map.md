...
| Phase C | roadmap + implementation plan | web-mcp-phase-c-execution-log + desktop flutter development runbook | desktop parity checklist + migration inventory + acceptance baseline |
