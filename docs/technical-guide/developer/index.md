...
desc: Dive into architecture, data models, and more. Start building today! See Penjar's technical guide for self-hosting, configuration, and developer insights.
---

# Developer Guide

This section is intended for people wanting to mess with the code or the inners
of Penjar application.
