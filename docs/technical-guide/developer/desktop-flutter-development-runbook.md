...
1. Secure credential-store migration for remote-stub auth snapshots (replace file/env-based auth snapshot persistence path with OS keychain/credential manager integration).
